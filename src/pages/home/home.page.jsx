...
import swipeIMG from '../../pages/firstAndFourthSkills/swipe.png';
...
const Home = () => {
    return (
        <div id="home-page" class="pt-4">
            ...
            <div class="bg-[#1c1f22]/90 h-auto rounded-md shadow-inner p-4 w-full max-w-4xl mx-auto border border-[#2a2d30]">
                ...
                <div class="mt-4 text-white rounded-md text-2xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 m-6 p-6">
                ...
                <Card title="1-4th Job Skills and Skill Swipe" image={swipeIMG} description="1-4th Job Skills and Skill Swipe" link="/first-and-fourth-skills" />
